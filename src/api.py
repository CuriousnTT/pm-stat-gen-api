...
#Locals
from src.pmabilities.abilities import get_ability_by_name as get_ability
...
def get_ability_by_name(name: str, full: Union[bool, None] = None):
    return get_ability(name, full=full)
